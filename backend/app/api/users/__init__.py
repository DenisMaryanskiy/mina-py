...
from app.api.users.logout import users_router
from app.api.users.presence import users_router
from app.api.users.profile import (
    users_router,  # /{user_id} last to avoid shadowing /search
)
from app.api.users.register import users_router
from app.api.users.resend import users_router
from app.api.users.search import (
    users_router,  # must be before profile (/{user_id})
)
